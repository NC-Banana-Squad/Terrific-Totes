...
def lambda_handler(event, context):
    ...
    table_names = {
        "sales_order": "fact_sales_order",  # implement conditional logic for if get()returns a list
    ...
    s3_client.put_object(
        Body=parquet_buffer.getvalue(), Bucket="banana-squad-processed-data", Key=path
    )
